...
Final State Machine for system, containing trigger events, state transitions and main loop.  
...
\item 
int \mbox{\hyperlink{fsm_8h_adc0ce09809b99f460acc793aa47e33ff}{fsm\+\_\+main\+\_\+loop}} (\mbox{\hyperlink{structtag__elevator}{Elevator}} $\ast$elev)
\begin{DoxyCompactList}\small\item\em Main loop which contains the entire system logic. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{fsm_8h_a84de27b9833d4216a1f47c9cec4a1711}{fsm\+\_\+init\+\_\+elevator}} (\mbox{\hyperlink{structtag__elevator}{Elevator}} $\ast$elev)
...
void \mbox{\hyperlink{fsm_8h_a1d9544e19109032702b02c9331db418d}{fsm\+\_\+arrive\+\_\+at\+\_\+floor}} (\mbox{\hyperlink{structtag__elevator}{Elevator}} $\ast$elev, int floor)
\begin{DoxyCompactList}\small\item\em Event triggered by active floor sensor. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{fsm_8h_a3381e73362b1c8480e54a67d0d5dc200}{fsm\+\_\+request\+\_\+btn\+\_\+pressed}} (\mbox{\hyperlink{structtag__elevator}{Elevator}} $\ast$elev, int floor, elev\+\_\+button\+\_\+type\+\_\+t button)
...
void \mbox{\hyperlink{fsm_8h_a760c7e760ec9134df442f0504a917e9e}{fsm\+\_\+stop\+\_\+btn\+\_\+pressed}} (\mbox{\hyperlink{structtag__elevator}{Elevator}} $\ast$elev)
...
void \mbox{\hyperlink{fsm_8h_a8c26e51e3d437770dd715c01e288d1db}{fsm\+\_\+timer\+\_\+timeout}} (\mbox{\hyperlink{structtag__elevator}{Elevator}} $\ast$elev)
...
void \mbox{\hyperlink{fsm_8h_ade8d2d046dca5b61c4265ba14eebf44e}{fsm\+\_\+move}} (\mbox{\hyperlink{structtag__elevator}{Elevator}} $\ast$elev)
...
void \mbox{\hyperlink{fsm_8h_a9994c1937638cecfc7643916ca193fe8}{fsm\+\_\+open\+\_\+doors}} (\mbox{\hyperlink{structtag__elevator}{Elevator}} $\ast$elev)
...
bool \mbox{\hyperlink{fsm_8h_a3af84a536ecf351833055f83328527c2}{fsm\+\_\+is\+\_\+btn\+\_\+pressed}} (elev\+\_\+button\+\_\+type\+\_\+t $\ast$button, int $\ast$floor)
...
elev\+\_\+motor\+\_\+direction\+\_\+t \mbox{\hyperlink{fsm_8h_af1361b15228c0d17a1f9eda4ef46f542}{fsm\+\_\+get\+\_\+direction}} (\mbox{\hyperlink{structtag__elevator}{Elevator}} $\ast$elev)
...
{\footnotesize\ttfamily void fsm\+\_\+arrive\+\_\+at\+\_\+floor (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{structtag__elevator}{Elevator}} $\ast$}]{elev,  }\item[{int}]{floor }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily elev\+\_\+motor\+\_\+direction\+\_\+t fsm\+\_\+get\+\_\+direction (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{structtag__elevator}{Elevator}} $\ast$}]{elev }\end{DoxyParamCaption})}
...
Definition at line 199 of file fsm.\+c.
...
{\footnotesize\ttfamily void fsm\+\_\+init\+\_\+elevator (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{structtag__elevator}{Elevator}} $\ast$}]{elev }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily bool fsm\+\_\+is\+\_\+btn\+\_\+pressed (\begin{DoxyParamCaption}\item[{elev\+\_\+button\+\_\+type\+\_\+t $\ast$}]{button,  }\item[{int $\ast$}]{floor }\end{DoxyParamCaption})}
...
Definition at line 180 of file fsm.\+c.
...
{\footnotesize\ttfamily int fsm\+\_\+main\+\_\+loop (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{structtag__elevator}{Elevator}} $\ast$}]{elev }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily void fsm\+\_\+move (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{structtag__elevator}{Elevator}} $\ast$}]{elev }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily void fsm\+\_\+open\+\_\+doors (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{structtag__elevator}{Elevator}} $\ast$}]{elev }\end{DoxyParamCaption})}
...
Definition at line 166 of file fsm.\+c.
...
{\footnotesize\ttfamily void fsm\+\_\+request\+\_\+btn\+\_\+pressed (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{structtag__elevator}{Elevator}} $\ast$}]{elev,  }\item[{int}]{floor,  }\item[{elev\+\_\+button\+\_\+type\+\_\+t}]{button }\end{DoxyParamCaption})}
...
Definition at line 84 of file fsm.\+c.
...
{\footnotesize\ttfamily void fsm\+\_\+stop\+\_\+btn\+\_\+pressed (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{structtag__elevator}{Elevator}} $\ast$}]{elev }\end{DoxyParamCaption})}
...
Definition at line 119 of file fsm.\+c.
...
{\footnotesize\ttfamily void fsm\+\_\+timer\+\_\+timeout (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{structtag__elevator}{Elevator}} $\ast$}]{elev }\end{DoxyParamCaption})}
...
Definition at line 148 of file fsm.\+c.
